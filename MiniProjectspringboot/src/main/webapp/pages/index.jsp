        ...
        <div class="container-xxl position-relative p-0" id="home">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="m-0">Modern College</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="studLogin" class="nav-item nav-link">Login here</a>
                        <a href="AdminLogin" class="nav-item nav-link">Admin login</a>
                    </div>
                    <a href="Register" class="btn btn-primary-gradient rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Registration</a>
                </div>
            </nav>
                ...
                <div class="container px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-8 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated slideInDown">THE COLLEGE WAS FOUNDED BY PROGRESSIVE EDUCATION SOCIETY, IN 1970.</h1>
